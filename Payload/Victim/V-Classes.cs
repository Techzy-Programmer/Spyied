...
namespace Payload.ActionClass
{
    ...
    public class TaskReport
    {
        ...
        public TaskReport Set(long FutCode, bool HasSucceeded)
        {
            FutID = FutCode;
            IsFutSucess = HasSucceeded;
            return this;
        }

        public static TaskReport Get(long TID, string SText, bool HasDone, bool HasFailed = false, Exception Ep = null)
            => new TaskReport
            {
                Error = Ep,
                TaskID = TID,
